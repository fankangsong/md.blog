...
$(function(){
    ...
    blog.duoshuo = function(){
        function ds(){
            ...
            el.setAttribute('data-url', blog.rooturl + blog.postdir + blog.parameter);
    ...
    blog.tags = function(){
        ...
        */
        ...
        return _.chain(blog.data).pluck('tag').uniq().value();
    }
    ...
    var AppRouter = Backbone.Router.extend({
        ...
        single: function(single){
            ...
            this.view(appview, 'post', single, 0);
            //不允许评论
            blog.comments = false;
        },
    ...
    $.getJSON('js/meta.json', function(response){
